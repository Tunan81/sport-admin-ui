...
<!--      @close="reset"-->
<!--  >-->
<!--&lt;!&ndash;    <GiForm ref="formRef" v-model="form" :options="options" :columns="columns" /> &ndash;&gt;-->
...
<!--        </a-form-item>-->
<!--&lt;!&ndash;        <a-form-item v-if="!isLabAdmin" label="维护人员姓名" field="userName"> &ndash;&gt;-->
<!--&lt;!&ndash;          <a-input v-model="form.userName" placeholder="请输入维护人员姓名" /> &ndash;&gt;-->
